...
public class App {
	...
	public static void main(String[] args) {
		...
		/*CommandeAvecBatterie commande_supplementaire_1 = new CommandeAvecBatterie("locale", true, laToulousaine, batterie_1);
		CommandeAvecBatterie commande_supplementaire_2 = new CommandeAvecBatterie("distante", true, laToulousaine,
				batterie_2);
		CommandeSansBatterie commande_supplementaire_3 = new CommandeSansBatterie("distante", true, laToulousaine);
		CommandeAvecBatterie commande_supplementaire_4 = new CommandeAvecBatterie("distante", true, laToulousaine, null);
		...
		PorteGarageAutomatique franceFermeture = new PorteGarageAutomatique("France Fermeture", "moteur a cremaillere",
				"coulissante", "PVC", 30.5, 5);
		Commande[] liste_commandes = new Commande[] { new CommandeAvecBatterie("locale", true, franceFermeture, batterie_4),
				new CommandeSansBatterie("distante", true, franceFermeture) };
		franceFermeture.setCommandes(liste_commandes);
		
		CommandeAvecBatterie commande_supplementaire_1 = new CommandeAvecBatterie("locale", true, franceFermeture, batterie_1);
		...
		CommandeAvecBatterie commande_supplementaire_4 = new CommandeAvecBatterie("distante", true, franceFermeture, null);
		...
		PorteGarageManuelle test2 = new PorteGarageManuelle("test",
				"coulissante", "PVC", 30.5);
		
		System.out.println(test1.toString());
		
		System.out.println(test1.ouvrir(23));
		System.out.println(test1.toString());
		
		System.out.println(test1.fermer(10));
		System.out.println(test1.toString());
		
		System.out.println(test1.fermer());
		System.out.println(test1.toString());
		
		System.out.println(test1.ouvrir(40));
		System.out.println(test1.toString());
		
		System.out.println(test1.ouvrir());
		System.out.println(test1.toString());		*/		
	}
}
